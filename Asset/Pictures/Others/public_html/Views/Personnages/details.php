			...
			<div class="container-fluid bg-light">
				...
				<div class="row">
					...
					<div class="col-sm-6">
							...
							select('id_equipement', $NomsArmesDisponibles,  ['label' => 'Armes à équiper']).
				...
				<div class="row">
					...
					<div class="col-sm-6">
							...
							select('id_equipement', $NomsTetesDisponibles,  ['label' => 'Tetes à équiper']).
							hidden('personnage_id', $_personnage['id']).
				...
				<div class="row">
					...
					<div class="col-sm-6">
							...
							select('id_equipement', $NomsTorsesDisponibles,  ['label' => 'Torses à équiper']).
							hidden('personnage_id', $_personnage['id']).
				...
				<div class="row">
					...
					<div class="col-sm-6">
							...
							select('id_equipement', $NomsJambessDisponibles,  ['label' => 'Jambes à équiper']).
							hidden('personnage_id', $_personnage['id']).
